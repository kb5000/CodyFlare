...
/*
 * Function: RaiseExceptionR
 * Usage: RaiseExceptionR(&e, name, value);
 * ---------------------------------------
...
void RaiseExceptionR(exception *e, string name, void *value);
...
#define raise(e) RaiseExceptionR(&e, #e, NULL)
